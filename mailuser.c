 ...
 */
int destroy_mail_list(mail_list_t list) {
    int errors = 0;
    while (list) {
 ...
 *  get_mail_count will return 3).  If the includedeleted parameter is true,
 ...
 */
unsigned int get_mail_count(mail_list_t list, int includedeleted) {
    unsigned int rv = 0;
    while (list) {
